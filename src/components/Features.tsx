  ...
  return <section className="py-24 bg-gradient-subtle">
      <div className="container px-4 mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => <div key={index} className="bg-card rounded-2xl p-8 shadow-elegant hover:shadow-glow transition-smooth group">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-smooth bg-[#b3585b]/65">
